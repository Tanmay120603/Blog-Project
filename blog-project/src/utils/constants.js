const loggedInNavItems=[{itemName:"Home",path:"/"},{itemName:"All Posts",path:"/posts"},{itemName:"My Posts",path:"/my/posts"},{itemName:"Add Post",path:"/add/post"}]
